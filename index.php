              ...
              <ul class="nav pull-right">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="pages/institutes.php">Institutes</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="pages/education.php">Education</a></li>
                ...
                <li><a href="pages/photo_gallery.php">Photo Gallery</a></li>
                <li><a href="pages/contact_us.php">Contact us</a></li>
                <li><a href="pages/signin.php">Sign in</a></li>
                <li><a href="pages/signup.php">Join now</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row-fluid">
          <div class="span4">
            <div class="page-header">
              ...
              <a href="pages/about_us.php" class="btn">Read more</a>
            </div>
          </div> 
          ...
          <div class="span4">
          	<div class="page-header">
              <a href="pages/news.php" class="btn">Read more</a>
            </div>
          </div> 
          <div class="span4">
          	<div class="page-header">
